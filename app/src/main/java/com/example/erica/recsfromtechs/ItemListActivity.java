...
import com.example.erica.recsfromtechs.dummy.States;
 ...
 *
 * THIS CODE IS AUTOGENERATED from the Master-Detail template.
 */
public class ItemListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(States.ITEMS));
    }
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public SimpleItemRecyclerViewAdapter(List<State> items) {
            mValues = items;
        }
